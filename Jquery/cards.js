$(document).ready(function(){
  ...
  $.ajax(settings).done(function (response) {
    ...
    for(var i=0;i<=total;i++)
    {
      ...
      $( "h2" ).append('<div class="card"><img src="F:/StartupMitra/data/'+logo+'" alt="John" style="width:100%">'+title+'</h1><p class="title">'+short_summary+'</p> <p>Harvard University</p>  <div style="margin: 24px 0;"><a href="#"><i class="fa fa-dribbble"></i></a> <a href="#"><i class="fa fa-twitter"></i></a>  <a href="#"><i class="fa fa-linkedin"></i></a>  <a href="#"><i class="fa fa-facebook"></i></a> </div><p><a href="file:///F:/StartupMitra/StartupMitra.github/profile/'+title+'">View</a></p></div>');  
    }
